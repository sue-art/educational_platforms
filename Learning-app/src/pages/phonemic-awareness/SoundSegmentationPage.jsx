        ...
        <div className="p-6 border rounded-lg">
          ...
          <div className="flex items-center space-x-4 mb-2">
            ...
            <Button
              ...
              size="icon"
              onClick={() =>
                alert(t("playing_word_placeholder", { word: "dog" }))
              }
            >
              {VolumeUp}{" "}
            </Button>
          ...
          <div className="flex items-center space-x-4">
            <Button
              onClick={() =>
                alert(t("selected_number_placeholder", { number: 1 }))
              }
            >
              1
            </Button>
            <Button
              onClick={() =>
                alert(t("selected_number_placeholder", { number: 2 }))
              }
            >
              2
            </Button>
            <Button
              onClick={() =>
                alert(t("selected_number_placeholder", { number: 3 }))
              }
            >
              3
            </Button>
            <Button
              onClick={() =>
                alert(t("selected_number_placeholder", { number: 4 }))
              }
            >
              4
            </Button>
          ...
          <div className="mt-4">
            <Button
              variant="secondary"
              onClick={() => alert(t("show_answer_placeholder_ss"))}
            >
              {t("show_answer")} (/d/, /o/, /g/)
            </Button>
          </div>
